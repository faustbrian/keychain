...
final readonly class KeychainManager
{
     ...
     *
     * Provides a fluent interface for configuring and issuing new tokens for a
     * tokenable entity (typically a User model). The conductor allows chaining
     * methods to set abilities, restrictions, metadata, and other token properties
     * before issuing the final token.
     *
     * @param  HasApiTokens&Model     $tokenable The model that will own the issued token
     ...
     */
    public function revoke(PersonalAccessToken $token): TokenRevocationConductor
    {
     ...
     *
     * @param  PersonalAccessToken      $parentToken The parent token from which to derive
     * @return TokenDerivationConductor Fluent conductor for derivation configuration
     */
    public function derive(PersonalAccessToken $parentToken): TokenDerivationConductor
    {
     ...
     * @return null|PersonalAccessToken The matched token or null if not found
     */
     ...
     */
    public function executeRevocation(PersonalAccessToken $token, ?string $strategy = null): void
    {
     ...
     *
     * @return class-string<PersonalAccessToken> The model class name
     */
     ...
     *
     * @param class-string<PersonalAccessToken> $model The custom model class to use
     */
     ...
     *
     * @param  Authenticatable&HasApiTokens $user      The user to authenticate
     * @param  array<string>                $abilities Token abilities (defaults to ['*'] for all)
     * @param  null|string                  $type      Optional token type identifier
     * @param  string                       $guard     Authentication guard name (defaults to 'keychain')
