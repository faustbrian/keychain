 ...
 * with the KeychainManager, or when no default hasher is configured.
 *
...
final class TokenHasherNotRegisteredException extends RuntimeException
{
     ...
     * that hasn't been registered via registerTokenHasher() on the KeychainManager.
     *
     ...
     * has been configured in the keychain configuration.
     *
     * @return self Exception instance with descriptive error message
     */
