...
final class CannotDeriveTokenException extends RuntimeException
{
     ...
     *
     * @param  PersonalAccessToken $parentToken The token that cannot derive children
     * @return self                Exception instance with descriptive error message
     */
    public static function fromParentToken(PersonalAccessToken $parentToken): self
    {
        $reason = match (true) {
