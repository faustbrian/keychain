...
/**
 * Configures model primary keys based on Bearer package configuration.
 *
 * This trait enables automatic primary key type detection and generation based
 * on the `bearer.primary_key_type` configuration. It supports standard auto-incrementing
