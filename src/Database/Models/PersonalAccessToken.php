 ...
 * @property null|int|string           $group_id              Foreign key to token_groups table
...
final class PersonalAccessToken extends Model implements HasAbilities
{
    ...
    public function isRootToken(): bool
    {
        ...
        return $this->isLineageRoot($hierarchyType);
    }
    ...
    {
        $maxDepth = Config::get('keychain.derivation.max_depth', 3);

        /** @var string */
        $hierarchyType = Config::get('keychain.derivation.hierarchy_type', 'token_derivation');

        $currentDepth = $this->getLineageDepth($hierarchyType);
    ...
    public function parentToken(): ?self
    {
        ...
        /** @var null|self */
        return $this->getLineageParent($hierarchyType);
    }
    ...
    public function childTokens(): Collection
    {
        ...
        return $this->getLineageChildren($hierarchyType);
    }
    ...
    public function allDescendantTokens(): Collection
    {
        ...
        /** @var Collection<int, self> */
        return $this->getLineageDescendants($hierarchyType);
    }
}
