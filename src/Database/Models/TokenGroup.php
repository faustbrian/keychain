 ...
 * @property string                               $owner_id   Polymorphic ID of the group owner
 * @property string                               $owner_type Polymorphic type of the group owner
 * @property Collection<int, PersonalAccessToken> $tokens     Tokens belonging to this group
...
final class TokenGroup extends Model
{
     ...
     *
     * @param  string                   $type The token type to retrieve
     ...
     *
     * @return null|PersonalAccessToken The secret key token if found
     */
     ...
     *
     * @return null|PersonalAccessToken The publishable key token if found
     */
     ...
     *
     * @return null|PersonalAccessToken The restricted key token if found
     */
     ...
     *
     * Sets the revoked_at timestamp on all tokens in the group.
     *
