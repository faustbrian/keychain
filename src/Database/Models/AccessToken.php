 ...
 * @property null|Model                $boundary              The boundary/tenant this token is scoped to
 * @property null|string               $boundary_id           Polymorphic foreign key ID for boundary
 * @property null|string               $boundary_type         Polymorphic foreign key type for boundary
 * @property null|Model                $context               The entity this token acts on behalf of
 * @property null|string               $context_id            Polymorphic foreign key ID for context
 * @property null|string               $context_type          Polymorphic foreign key type for context
