...
namespace Cline\Keychain\Concerns;
 ...
 * ```
 *
 * @template TToken of \Cline\Keychain\Contracts\HasAbilities
 *
 * @mixin Model
 *
...
trait HasApiTokens
{
     ...
     *
     * Returns a polymorphic relationship to PersonalAccessToken models, allowing
     ...
     * ```
     *
     * @return MorphMany<PersonalAccessToken, $this> Relationship to PersonalAccessToken models
     */
    public function tokens(): MorphMany
    {
        return $this->morphMany(
            Keychain::personalAccessTokenModel(),
            'tokenable',
        );
    }
     ...
     *
     * Returns a polymorphic relationship to TokenGroup models, enabling logical
     ...
     * ```
     *
     * @return MorphMany<TokenGroup, $this> Relationship to TokenGroup models
     */
    public function tokenGroups(): MorphMany
    {
        /** @var class-string<TokenGroup> $model */
        $model = Keychain::tokenGroupModel();
    ...
    public function createToken(
        ...
        return Keychain::for($this)->issue(
            type: $type,
            name: $name,
            abilities: $abilities,
     ...
     * @return TokenGroup           The created token group with all tokens accessible
     */
    public function createTokenGroup(
        array $types,
        string $name,
        array $abilities = [],
        ?string $environment = null,
        ...
        return Keychain::for($this)->issueGroup(
            types: $types,
            name: $name,
            abilities: $abilities,
            environment: $environment,
    ...
    {
        if (!$this->accessToken instanceof PersonalAccessToken) {
            return false;
        }
     ...
     * or null if no PersonalAccessToken is associated.
     *
     * Common environments:
