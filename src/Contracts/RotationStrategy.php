...
interface RotationStrategy
{
     ...
     *
     * @param PersonalAccessToken $oldToken The token being rotated/replaced
     * @param PersonalAccessToken $newToken The newly created replacement token
     */
    public function rotate(PersonalAccessToken $oldToken, PersonalAccessToken $newToken): void;
     ...
     *
     * @param  PersonalAccessToken $oldToken The rotated token to check validity for
