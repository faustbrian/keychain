...
interface HasApiTokens
{
     ...
     *
     * Returns a morph many relationship to the PersonalAccessToken model,
     * allowing you to query, create, update, and delete tokens associated
     * with this tokenable entity.
     *
     * @return MorphMany<PersonalAccessToken, covariant Model> Relationship to PersonalAccessToken models
     */
     ...
     *
     * Returns a morph many relationship to the TokenGroup model, enabling
     * logical organization of tokens into named groups (e.g., 'mobile-app',
     * 'integrations', 'admin-tools').
     *
     * @return MorphMany<TokenGroup, covariant Model> Relationship to TokenGroup models
     */
