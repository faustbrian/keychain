...
final class ImmediateInvalidationStrategy implements RotationStrategy
{
     ...
     *
     * @param PersonalAccessToken $oldToken The existing token being rotated and revoked
     * @param PersonalAccessToken $newToken The newly generated replacement token
     */
     ...
     *
     * @param  PersonalAccessToken $oldToken The old token to validate
