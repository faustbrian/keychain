...
final class CascadeDescendantsStrategy implements RevocationStrategy
{
     ...
     * This ensures complete invalidation of an entire token lineage.
     *
     * @param PersonalAccessToken $token The token to revoke along with its descendants
     */
    public function revoke(PersonalAccessToken $token): void
    {
        ...
        // Get all descendants
        $descendants = Lineage::getDescendants($token, $hierarchyType, includeSelf: false);
     ...
     * @return Collection<int, PersonalAccessToken> Collection containing the token and all descendants
     */
    public function getAffectedTokens(PersonalAccessToken $token): Collection
    {
        ...
        $descendants = Lineage::getDescendants($token, $hierarchyType, includeSelf: true);
