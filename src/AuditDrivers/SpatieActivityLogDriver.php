...
final readonly class SpatieActivityLogDriver implements AuditDriver
{
     ...
     *
     * @param string $logName The log name to use for activity entries (default: 'keychain')
     */
    public function __construct(
        private string $logName = 'keychain',
    ) {}
     ...
     */
    public function getLogsForToken(PersonalAccessToken $token): EloquentCollection
    {
