...
final readonly class TokenQueryConductor
{
     ...
     *
     * @param HasApiTokensContract&Model $tokenable Model that owns the tokens
     */
     ...
     *
     * @return EloquentCollection<int, PersonalAccessToken> Collection of matching tokens
     */
    public function get(): EloquentCollection
    {
        /** @var EloquentCollection<int, PersonalAccessToken> */
     ...
     *
     * @return null|PersonalAccessToken The first matching token or null
     */
     ...
     *
     * @return Builder<PersonalAccessToken> The Eloquent query builder
     */
