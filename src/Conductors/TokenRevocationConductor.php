...
final readonly class TokenRevocationConductor
{
     ...
     *
     * @param KeychainManager     $manager core keychain manager instance providing access
     *                                     to audit logging functionality for tracking
     *                                     revocation events and their context
     * @param PersonalAccessToken $token   The token to be revoked. This can be a single
    ...
    private function revokePartial(): void
    {
        ...
        $affectedCount = PersonalAccessToken::query()
