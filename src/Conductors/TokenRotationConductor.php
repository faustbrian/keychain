...
final readonly class TokenRotationConductor
{
    ...
    public function rotate(): NewAccessToken
    {
        ...
        $plainTextAccessToken = $generator->generate($tokenType->prefix(), $this->token->environment);
        ...
        $createdToken = $owner->accessTokens()->create($tokenData);
        ...
        return new NewAccessToken($createdToken, $plainTextAccessToken);
    }
