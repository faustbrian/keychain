...
namespace Cline\Keychain\Console\Commands;
...
final class PruneExpiredCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'keychain:prune-expired
    ...
    {
        /** @var int */
        $hours = $this->option('hours') ?? Config::get('keychain.prune.expired_hours', 24);

        /** @var class-string<PersonalAccessToken> $model */
        $model = Keychain::personalAccessTokenModel();
