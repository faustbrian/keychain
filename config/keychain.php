...
/*
|--------------------------------------------------------------------------
| Keychain Token Management Configuration
|--------------------------------------------------------------------------
|
| This file defines the configuration for Keychain, a Laravel package for
| managing API tokens with multi-environment support, granular permissions,
| token groups, audit logging, and rate limiting. Keychain provides a
...
use Cline\Keychain\RevocationStrategies\CascadeDescendantsStrategy;
...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | This option controls the type of primary key used in Keychain's database
    ...
    */
    ...
    'primary_key_type' => env('KEYCHAIN_PRIMARY_KEY_TYPE', 'id'),
    /*
    |--------------------------------------------------------------------------
    | Morph Type
    |--------------------------------------------------------------------------
    ...
    | for tokenable relationships in Keychain's database tables. This determines
    ...
    */
    ...
    'morph_type' => env('KEYCHAIN_MORPH_TYPE', 'numeric'),
    /*
    |--------------------------------------------------------------------------
    | Environments
    |--------------------------------------------------------------------------
    |
    | Keychain supports multi-environment token management, allowing you to
    ...
    */
    ...
    'environments' => [
        ...
        */
        ...
        'default' => env('KEYCHAIN_DEFAULT_ENVIRONMENT', 'test'),
    ],
    /*
    |--------------------------------------------------------------------------
    | Token Generation
    |--------------------------------------------------------------------------
    |
    | These options control how API tokens are generated. Keychain supports
    ...
    */
    ...
    'generator' => [
        ...
        */
        ...
        'default' => env('KEYCHAIN_GENERATOR', 'seam'),
        /*
        |--------------------------------------------------------------------------
    ...
    | Keychain supports multiple hashing algorithms to balance security
    ...
    */
    ...
    'hasher' => [
        ...
        */
        ...
        'default' => env('KEYCHAIN_HASHER', 'sha256'),
    ...
    |--------------------------------------------------------------------------
    |
    | Keychain supports multiple token types with different security levels
    ...
    */
    ...
    'types' => [
        ...
        */
        ...
        | helper methods on TokenGroup models. This allows you to customize
    ...
    |--------------------------------------------------------------------------
    |
    | These options control how Keychain logs token usage and security events.
    ...
    */
    ...
    'audit' => [
        ...
        */
        ...
        'driver' => env('KEYCHAIN_AUDIT_DRIVER', 'database'),
        /*
        |--------------------------------------------------------------------------
        ...
        |
        | - database: Stores audit logs in the token_audit_logs table with
        ...
        */
        ...
        |--------------------------------------------------------------------------
        |
        | When enabled, Keychain will log every API request made with a token.
        ...
        */
        ...
        | they become eligible for pruning. Configure the keychain:prune-audit-logs
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | These options control rate limiting for API tokens. Keychain provides
    ...
    */
    ...
    | is revoked. Keychain supports multiple revocation strategies including
    ...
    */
    ...
    'revocation' => [
        ...
        */
        ...
        'default' => env('KEYCHAIN_REVOCATION_STRATEGY', 'none'),
    ...
    */
    ...
    'rotation' => [
        ...
        */
        ...
        'default' => env('KEYCHAIN_ROTATION_STRATEGY', 'immediate'),
    ...
    */
    ...
    'derivation' => [
        ...
        | tokens can derive child tokens using the Lineage hierarchical system.
        | Disable this if you don't need hierarchical token relationships.
        |
        */

        'enabled' => env('KEYCHAIN_DERIVATION_ENABLED', true),
        ...
        */
        ...
        'max_depth' => env('KEYCHAIN_MAX_DERIVATION_DEPTH', 3),
        ...
        |--------------------------------------------------------------------------
        |
        | This option specifies the Lineage hierarchy type identifier used for
    ...
    |--------------------------------------------------------------------------
    |
    | When using Keychain's database features, these models are used to
    ...
    | by Keychain. This allows you to customise model behavior whilst
    | maintaining compatibility with Keychain's internal operations.
    |
    */
    ...
    'models' => [
        ...
        | The model you specify must extend the `Cline\Keychain\Database\Models\PersonalAccessToken`
        ...
        */
        ...
        | The model you specify must extend the `Cline\Keychain\Database\Models\TokenGroup`
        ...
        */
        ...
        | The model you specify must extend the `Cline\Keychain\Database\Models\TokenAuditLog`
    ...
    |--------------------------------------------------------------------------
    |
    | When using Keychain's database features, these table names are used to
    ...
    */
    ...
    | authenticating requests with Keychain tokens. By default, the 'web'
    ...
    */
    ...
    'stateful' => explode(',', env('KEYCHAIN_STATEFUL_DOMAINS', sprintf(
        '%s%s',
    ...
    */
    ...
    | stateful frontend requests. By default, Keychain uses Laravel's standard
    ...
    */
    ...
    | Keychain will then use the correct column when storing foreign keys.
    |
