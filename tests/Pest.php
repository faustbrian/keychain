 ...
 *
 * Issues a token using the Keychain service for the specified user. Supports
 ...
 * @return PersonalAccessToken  The created token model instance
 */
function createToken(User $user, string $type = 'sk', array $attributes = []): PersonalAccessToken
{
    $newToken = Keychain::for($user)->issue(
        type: $type,
