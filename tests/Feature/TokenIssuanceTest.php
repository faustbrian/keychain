...
describe('Token Issuance', function (): void {
    it('issues a single token', function (): void {
        ...
        expect($result->plainTextAccessToken)->toStartWith('sk_test_');
    ...
    it('generates unique tokens', function (): void {
        ...
        expect($token1->plainTextAccessToken)->not->toBe($token2->plainTextAccessToken);
    ...
    it('assigns correct token prefix based on type', function (): void {
        ...
        expect($secretKey->plainTextAccessToken)->toStartWith('sk_test_');
        expect($publishableKey->plainTextAccessToken)->toStartWith('pk_test_');
        expect($restrictedKey->plainTextAccessToken)->toStartWith('rk_test_');
