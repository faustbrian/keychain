...
describe('Token Issuance', function (): void {
    it('issues a single token', function (): void {
        ...
        $result = Keychain::for($user)->issue(
            type: 'sk',
            name: 'My API Key',
        );
    ...
    it('generates unique tokens', function (): void {
        ...
        $token2 = Keychain::for($user)->issue('sk', 'Token 2');
    ...
    it('stores hashed token', function (): void {
        ...
        $result = Keychain::for($user)->issue('sk', 'API Key');
    ...
    it('assigns correct token prefix based on type', function (): void {
        ...
        $secretKey = Keychain::for($user)->issue('sk', 'Secret');
        $publishableKey = Keychain::for($user)->issue('pk', 'Publishable');
        $restrictedKey = Keychain::for($user)->issue('rk', 'Restricted');
