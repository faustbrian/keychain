...
describe('CascadeStrategy', function (): void {
    describe('Happy Path', function (): void {
        test('revokes all tokens in group when token is part of a group', function (): void {
            ...
            $group = TokenGroup::query()->forceCreate([
                'owner_type' => User::class,
                'owner_id' => $user->id,
                'name' => 'test-group',
            ]);

            $token1 = PersonalAccessToken::query()->forceCreate([
            ...
            $token2 = PersonalAccessToken::query()->forceCreate([
                'tokenable_type' => User::class,
                'tokenable_id' => $user->id,
                'group_id' => $group->id,
                'type' => 'api',
            ...
            $token3 = PersonalAccessToken::query()->forceCreate([
                'tokenable_type' => User::class,
                'tokenable_id' => $user->id,
                'group_id' => $group->id,
                'type' => 'api',
...
describe('PartialCascadeStrategy', function (): void {
    describe('Happy Path', function (): void {
        test('revokes only default prefix tokens in group', function (): void {
            ...
            $skToken = PersonalAccessToken::query()->forceCreate([
                'tokenable_type' => User::class,
                'tokenable_id' => $user->id,
                'group_id' => $group->id,
                'type' => 'api',
            ...
            $rkToken = PersonalAccessToken::query()->forceCreate([
                'tokenable_type' => User::class,
                'tokenable_id' => $user->id,
                'group_id' => $group->id,
                'type' => 'api',
            ...
            $pkToken = PersonalAccessToken::query()->forceCreate([
                'tokenable_type' => User::class,
                'tokenable_id' => $user->id,
                'group_id' => $group->id,
                'type' => 'api',
        ...
        test('revokes only custom prefix tokens in group', function (): void {
            ...
            $customToken = PersonalAccessToken::query()->forceCreate([
                'tokenable_type' => User::class,
                'tokenable_id' => $user->id,
                'group_id' => $group->id,
                'type' => 'api',
