...
describe('PersonalAccessToken Model', function (): void {
    describe('Happy Path', function (): void {
        test('findToken() locates token by plain text hash when no prefix', function (): void {
            // Arrange
            $user = createUser();
            $newToken = Keychain::for($user)->issue('sk', 'Test Token');
            $plainToken = $newToken->plainTextToken;

            // Act
            $found = Keychain::findToken($plainToken);
        ...
        test('findToken() locates token by prefixed token with id', function (): void {
            ...
            // Act
            $found = Keychain::findToken($prefixedToken);
    ...
    describe('Sad Path', function (): void {
        test('findToken() returns null when prefixed token id does not exist', function (): void {
            ...
            // Act
            $found = Keychain::findToken($invalidToken);
...
describe('TokenGroup Model', function (): void {
    describe('Happy Path', function (): void {
