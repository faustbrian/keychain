...
describe('NewAccessToken', function (): void {
    describe('Happy Path', function (): void {
        ...
        test('accessToken property holds the PersonalAccessToken model', function (): void {
            // Arrange
            $personalAccessToken = new PersonalAccessToken([
                'type' => 'secret_key',
            ...
            // Assert
            expect($newAccessToken->accessToken)->toBeInstanceOf(PersonalAccessToken::class);
    ...
    describe('Edge Cases', function (): void {
        ...
        test('handles different token types', function (): void {
            // Arrange
            $secretKey = new PersonalAccessToken([
                'type' => 'secret_key',
                'environment' => 'testing',
                'name' => 'Secret Key',
            ...
            $publishableKey = new PersonalAccessToken([
                'type' => 'publishable_key',
                'environment' => 'testing',
        ...
        test('handles different environments', function (): void {
            // Arrange
            $prodToken = new PersonalAccessToken([
                'type' => 'secret_key',
                'environment' => 'production',
            ...
            $devToken = new PersonalAccessToken([
                'type' => 'secret_key',
                'environment' => 'development',
