...
return [
    ...
    'generator' => env('KEYCHAIN_GENERATOR', 'seam'),
...
'generators' => [
    'short' => [
        'class' => App\Keychain\ShortTokenGenerator::class,
        'length' => 8,
    ],
    'hash' => [
        'class' => App\Keychain\HashTokenGenerator::class,
    ],
    'base62' => [
        'class' => App\Keychain\Base62TokenGenerator::class,
        'length' => 22,
    ],
],
```
