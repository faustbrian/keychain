...
This guide demonstrates the fundamental operations of the Keychain package.
...
$token = Keychain::findToken('sk_test_abc123...');

// Find by prefix (partial match)
$token = Keychain::findByPrefix('sk_test_abc');
```
