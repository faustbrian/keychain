...
Keychain provides Stripe-style typed API tokens with groups, environments, and audit logging for Laravel applications.

## Requirements

Keychain requires PHP 8.4+ and Laravel 11+.

## Installation

Install Keychain with composer:
...
Add Keychain's trait to your user model:
...
Keychain supports different polymorphic relationship types. Configure this **before** running migrations:
...
return [
    'database' => [
        ...
        'primary_key' => env('KEYCHAIN_PRIMARY_KEY', 'numeric'),
        ...
        'connection' => env('KEYCHAIN_DB_CONNECTION'),
    ],
];
```
...
Whenever you use the `Keychain` facade in your code, remember to add this line to your namespace imports:
