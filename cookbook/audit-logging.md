...
Keychain automatically logs these events:
...
```php
$token = Keychain::for($user)->issue('sk', 'My Token');
    ...
    'audit' => [
        ...
        'drivers' => [
            ...
            'spatie' => [
                ...
                'log_name' => 'keychain', // Spatie activity log name
            ],
            'null' => [
...
$activities = Activity::inLog('keychain')
...
```bash
php artisan keychain:prune-audit-logs --days=90
```

In `app/Console/Kernel.php`:

```php
$schedule->command('keychain:prune-audit-logs')->daily();
```
